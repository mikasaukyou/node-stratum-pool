...
this.target = rpcData.target ?
    util.bignumFromBuffer(new Buffer(rpcData.target, 'hex')) :
    util.bignumFromBitsBuffer(new Buffer(rpcData.bits, 'hex'));

this.difficulty = parseFloat((util.diff1.div(this.target)).toFixed(9));
